...
//         console.log('Data from::::::', medicineListData);
//         console.log('Hello');
//       } else {
//         await getMedicineListData();
//         const refreshedData = mmkvStorage.getString('medicineListData');
//         global.medicineListData = refreshedData
//           ? JSON.parse(refreshedData)
//           : [];
//         console.log('Fetched from API and now stored:', refreshedData);
...
//     try {
//       let response = await getRequest('api/Definition/List/Medication');
//       console.warn('response', response);
//       if (response.code === 200 && response.data[0]) {
